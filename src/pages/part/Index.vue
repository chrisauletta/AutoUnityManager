  ...
  <q-page padding class="">
    <q-card class="q-mb-lg">
      <div class="col-6 text-black q-px-lg q-py-md">
        <h5 style="margin: 0px">Central de Peças</h5>
        <hr />
      </div>
      <q-card-section>
        <div class="row">
            ...
            >
              <template v-slot:body-cell-buttons="props">
                  <q-td key="buttons" :props="props" auto-width>
                    <q-btn color="primary" icon="visibility" @click="$refs.modalPart.openModal(props.row.id, true)"/>
...
export default {
  ...
  methods: {
    async search() {
      this.rows = await this.apiGet("parts");
    },
    async tratarFiltro() {
      var query = {
        search:true
